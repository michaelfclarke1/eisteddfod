...
/**
 * Database controller for the Eisteddfod application. Deals with
 * locating, copying and accessing the language database.
 * 
...
public class DatabaseController extends SQLiteOpenHelper {
	...
	private static String TAG = "DatabaseController";
	private static int DATABASE_VERS = 1;
	private static String DATABASE_PATH = null;
	private static HashMap<String, DatabaseController> instances;
	 ...
	 *  
	 * <code>
	 *  DatabaseController dbOne = DatabaseController.getInstance(
	 *  								getApplicationContext(), "mydatabase");
	 *  DatabaseController dbTwo = DatabaseController.getInstance(
	...
	public static DatabaseController
		...
		if (instances == null)
			instances = new HashMap<String, DatabaseController>();
		...
		DatabaseController instance = instances.get(dbName);
		if (instance == null) {
			instance = new DatabaseController(context, dbName + ".sqlite");
	...
	private DatabaseController(Context context, String dbName) {
